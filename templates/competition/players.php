								...
								<ul class="row player-list-letter">
									...
									foreach ( $players as $player ) {
										...
										<li class="alphabet-list-item col-12 col-sm-6 col-md-4">
											<a href="/<?php echo esc_html( seo_url( $competition->name ) ); ?>/<?php echo esc_attr( $competition->current_season['name'] ); ?>/player/<?php echo esc_attr( seo_url( $player->display_name ) ); ?>/">
