...
class RacketManager {
	...
	*/
	private function loadLibraries() {
		...
		// Objects
		require_once (dirname (__FILE__) . '/lib/class-charges.php');
		require_once (dirname (__FILE__) . '/lib/class-invoice.php');
...
function setup_racketmanager_plugin() {
	...
	define( 'RACKETMANAGER_VERSION', '7.1.0' );
	define( 'RACKETMANAGER_DBVERSION', '7.2.0' );
