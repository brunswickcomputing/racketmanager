<div class="container">
	...
	<?php if ( $competition->getSeasonCompetition() && $matches = $racketmanager->getMatches(array('competitionId' => $competition->id, 'season' => $competition->getSeasonCompetition()['name'], 'orderby' => array('match_day' => 'ASC', 'date' => 'ASC', 'league_id' => 'ASC', 'home_team' => 'ASC'))) ) {
		$class = '';
		$matchDay = '';
