...
<div class="wrap league-block">
    ...
    <form action="admin.php?page=leaguemanager&amp;subpage=show-league&amp;league_id=<?php echo $league_id ?>&amp;season=<?php echo $season ?>" method="post" enctype="multipart/form-data" name="team_edit" id="teamPlayerFrm" >
        ...
        <div class="form-group">
            <label for="teamPlayer1"><?php _e( 'Player 1', 'leaguemanager' ) ?></label>
            <div class="input">
        ...
        <?php if ( substr($league->type,1,1) == 'D'  ) { ?>
            <div class="form-group">
                <label for="teamPlayer2"><?php _e( 'Player 2', 'leaguemanager' ) ?></label>
                <div class="input">
        ...
        <div class="form-group">
            ...
            <div class="input">
                <select size="1" name="affiliatedclub" id="affiliatedclub" >
                    <option value=""><?php _e( 'Select club' , 'leaguemanager') ?></option>
