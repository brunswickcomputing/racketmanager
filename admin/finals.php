<div class="championship-block">
    ...
    <?php $matches = $leaguemanager->getMatches( array("league_id" => $league->id, "final" => (!empty($final['key']) ? $final['key'] : '' ), "season" => $season['name'], "orderby" => array("id" => "ASC")) ); ?>
    ...
    <?php for ( $i = 1; $i <= ( isset($final['num_matches']) ? $final['num_matches'] : 0 ); $i++ ) {
        ...
        if ( isset($match->id) ) {
            ...
            <tr class="<?php echo $class ?>">
                ...
                <td class="match-title"><a href="admin.php?page=leaguemanager&amp;subpage=match&amp;league_id=<?php echo $league->id ?>&amp;edit=<?php echo $match->id ?>&amp;season=<?php echo $season['name'] ?>"><?php echo $title ?></a></td>
