<div class="row justify-content-center">
  <div class="col-12 col-md-9">
    ...
    <?php if ( isset( $user_data['message'] ) )  {
      ...
      <div id="profile-message" class="<?php echo $class ?>"><?php echo $user_data['message']; ?></div>
    <?php } ?>
    ...
    <form name="memberaccountform" id="memberaccountform" action="<?php echo site_url( 'member-account' ); ?>" method="post" autocomplete="off">
      ...
      <fieldset>
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['user_name_error'])) echo 'is-invalid' ?>">
          <input type="email" required="required" placeholder="<?php _e( 'Email Address', 'racketmanager' ) ?>" name="username" id="username" class="form-control" value="<?php echo $user_data['user_name'] ?>" <?php if (isset($user_data['user_name']) && $user_data['user_name'] != '' ) echo 'readonly' ?> />
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['first_name_error'])) echo 'is-invalid' ?>">
          <input type="text" autocomplete='given-name' placeholder="<?php _e( 'First Name', 'racketmanager' ) ?>" name="firstname" id="firstname" class="form-control" value="<?php echo $user_data['first_name'] ?>" />
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['last_name_error'])) echo 'is-invalid' ?>">
          <input type="text" autocomplete='family-name' placeholder="<?php _e( 'Last Name', 'racketmanager' ) ?>" name="lastname" id="lastname" class="form-control" value="<?php echo $user_data['last_name'] ?>" />
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['contactno_error'])) echo 'is-invalid' ?>">
          <input type="tel" autocomplete='tel' placeholder="<?php _e( 'Telephone Number', 'racketmanager' ) ?>" name="contactno" id="contactno" class="form-control" value="<?php echo $user_data['contactno'] ?>" />
        ...
        <div class="form-group mb-3 <?php if (isset($user_data['gender_error'])) echo 'field_error' ?>">
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['btm_error'])) echo 'is-invalid' ?>">
          <input type="tel" placeholder="<?php _e( 'BTM Number', 'racketmanager' ) ?>" name="btm" id="btm" class="form-control" value="<?php echo $user_data['btm'] ?>" />
      ...
      <fieldset>
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['password_error'])) echo 'is-invalid' ?>">
        ...
        <div class="form-floating mb-3 <?php if (isset($user_data['rePassword_error'])) echo 'is-invalid' ?>">
