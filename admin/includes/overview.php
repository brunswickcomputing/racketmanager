...
?>
	...
	<div class="alert_rm" id="alert-<?php echo esc_attr( $competition->type ); ?>s" style="display:none;">
		<div class="alert__body">
			<div class="alert__body-inner" id="alert-<?php echo esc_attr( $competition->type ); ?>s-response">
			</div>
		</div>
	</div>
