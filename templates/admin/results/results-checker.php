<?php
/**
 * Result checker administration panel
 *
                    ...
                    if ( $results_checkers ) {
                        ...
                        foreach ( $results_checkers as $results_checker ) {
                            ...
                            <tr>
                                ...
                                <td class=""><?php echo esc_html( $results_checker->formatted_date ); ?></td>
                                <td class="">
                                    <a href="<?php echo esc_html( $results_checker->match_link ); ?>">
                                        <?php echo esc_html( $results_checker->match_title ); ?>
                                    </a>
                                </td>
                                <td class=""><?php echo esc_html( $results_checker->team_title ); ?></td>
                                <td class="">
                                    <?php if ( $results_checker->player_link ) : ?>
                                        <a href="<?php echo esc_attr( $results_checker->player_link ); ?>">
                                            <?php echo esc_html( $results_checker->player_name ); ?>
                                        </a>
                                    <?php else : ?>
                                        <?php echo esc_html( $results_checker->player_name ); ?>
                                    <?php endif; ?>
                                ...
                                <?php if ( $results_checker->show_status ) : ?>
                                    <td data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="<?php echo esc_html( $results_checker->tooltip ); ?>"><?php echo esc_html( $results_checker->status_desc ); ?></td>
                                <?php endif; ?>
                            </tr>
                            <?php
                        }
