      ...
      <tr>
        <td>
          <div>
            ...
            <p>Your email address has now been changed for your <?php echo $organisationName ?> account.</p>
            <p>The new email address is ###NEW_EMAIL###.</p>
            <p>If you did not change your email address, please <a href="mailto:<?php echo $emaillink ?>">contact the team</a>.</p>
            <p>Thanks,</p>
