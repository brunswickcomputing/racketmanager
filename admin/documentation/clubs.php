<div class="container">
  ...
  <ul class="nav nav-pills" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active show" id="clubslist-tab" data-bs-toggle="pill" data-bs-target="#clubslist" type="button" role="tab" aria-controls="clubslist" aria-selected="true"><?php _e( 'Clubs List', 'racketmanager' ) ?></button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="clubadd-tab" data-bs-toggle="pill" data-bs-target="#clubadd" type="button" role="tab" aria-controls="clubadd" aria-selected="true"><?php _e( 'Add Club', 'racketmanager' ) ?></button>
    </li>

    <li class="nav-item" role="presentation">
      <button class="nav-link" id="clubplayers-tab" data-bs-toggle="pill" data-bs-target="#clubplayers" type="button" role="tab" aria-controls="clubplayers" aria-selected="false"><?php _e( 'Players', 'racketmanager' ) ?></button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="clubteams-tab" data-bs-toggle="pill" data-bs-target="#clubteams" type="button" role="tab" aria-controls="clubteams" aria-selected="false"><?php _e( 'Teams', 'racketmanager' ) ?></button>
    </li>
  </ul>
  <!-- Tab panes -->
  <div class="container tab-content">
    ...
    <div class="tab-pane fade" id="clubadd" role="tabpanel" aria-labelledby="tournaclubaddmentadd-tab">
