	...
	<div id="invoice-amount">
		...
		<div id="invoice-items">
			...
			<div id="invoice-item">
				...
				<div class="invoice-item-unit-price"><?php echo esc_html( numfmt_format_currency( $racketmanager_fmt, $invoice->charge->fee_club, $billing['billingCurrency'] ) ); ?></div>
				<div class="invoice-item-net-price"><?php echo esc_html( numfmt_format_currency( $racketmanager_fmt, $invoice->charge->fee_club, $billing['billingCurrency'] ) ); ?></div>
			</div>
			<?php foreach ( $entry->events as $racketmanager_event ) { ?>
				<div id="invoice-item">
					...
					<div class="invoice-item-unit-price"><?php echo esc_html( numfmt_format_currency( $racketmanager_fmt, $invoice->charge->fee_team, $billing['billingCurrency'] ) ); ?></div>
					<div class="invoice-item-net-price"><?php echo esc_html( numfmt_format_currency( $racketmanager_fmt, $racketmanager_event->fee, $billing['billingCurrency'] ) ); ?></div>
				</div>
			<?php } ?>
		</div>
		<div id="invoice-totals">
			<div class="invoice-total-desc">Total</div>
			<div class="invoice-item-net-price"><?php echo esc_html( numfmt_format_currency( $racketmanager_fmt, $entry->fee, $billing['billingCurrency'] ) ); ?></div>
		</div>
