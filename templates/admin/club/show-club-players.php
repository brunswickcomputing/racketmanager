...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <form id="players-action" method="post" action="" class="form-control">
            <?php wp_nonce_field( 'racketmanager_club-players-bulk', 'racketmanager_nonce' ); ?>
                    ...
                    foreach ( $players as $player ) {
                        ...
                        <tr class="">
                            <td class="col-1 col-md-1 check-column">
                                <?php
                                if ( ! isset( $player->removal_date ) ) {
                                    ?>
                                    <label for="clubPlayer-<?php echo esc_html( $player->registration_id ); ?>" class="visually-hidden"><?php esc_html_e( 'Check', 'racketmanager' ); ?></label><input type="checkbox" value="<?php echo esc_html( $player->registration_id ); ?>" name="clubPlayer[<?php echo esc_html( $player->registration_id ); ?>]" id="clubPlayer-<?php echo esc_html( $player->registration_id ); ?>" />
                                    <?php
                                }
                                ?>
                            </td>
                            <td class="col-4 col-md-2">
                                <?php
                                if ( ! isset( $player->removal_date ) ) {
                                    echo '<a href="/wp-admin/admin.php?page=racketmanager-clubs&amp;view=player&amp;club_id=' . esc_html( $club->id ) . '&amp;player_id=' . esc_html( $player->user_id ) . '">';
                                }
