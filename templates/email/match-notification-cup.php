...
<body class="">
  <span class="preheader"><?php echo $homeTeam; ?> - <?php echo $awayTeam; ?></span>
                  ...
                  <tr>
                    <td>
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td><h2 class="align-center"><?php echo $competitionName; ?></h2></td>
                        </tr>
                        <tr>
                          <td><h3 class="align-center"><?php echo $round; ?></h3></td>
                        </tr>
                        <tr>
                          <td>
