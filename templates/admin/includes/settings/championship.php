            ...
            foreach ( $grades as $grade => $grade_desc ) {
                ...
                <div class="col-3 col-md-1 mb-3 mb-md-0">
                    <div class="form-floating">
                        ...
                        <label for='dateClose-<?php echo esc_attr( $grade ); ?>'><?php echo esc_html__( 'Grade', 'racketmanager' ) . ' championship.php' . esc_html( $grade ); ?></label>
                    </div>
                </div>
                <?php
            }
            ...
            foreach ( $grades as $grade => $grade_desc ) {
                ...
                <div class="col-3 col-md-1 mb-3 mb-md-0">
                    <div class="form-floating">
                        ...
                        <label for='dateWithdraw-<?php echo esc_attr( $grade ); ?>'><?php echo esc_html__( 'Grade', 'racketmanager' ) . ' championship.php' . esc_html( $grade ); ?></label>
                    </div>
                </div>
                <?php
            }
