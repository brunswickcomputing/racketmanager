...
$racketmanager_match_args['status']  = 'D';
	...
	if ( $racketmanager_matches ) {
		foreach ( $racketmanager_matches as $racketmanager_match ) {
            ...
            <tr data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="<?php echo esc_html( $tooltip ); ?>">
                ...
                <td class="match-title"><a href="<?php echo esc_html( $racketmanager_match->link ); ?>?referrer=postponed; ?>"><?php echo esc_html( $racketmanager_match->match_title ); ?></a></td>
                <td class=""><a href="<?php echo esc_html( $racketmanager_match->link ); ?>result/?referrer=postponed" class="btn btn-primary"><?php esc_html_e( 'Enter result', 'racketmanager' ); ?></a>                </tr>
			<?php
		}
	} else {
		?>
