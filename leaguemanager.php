...
class LeagueManagerLoader
{
	...
	function getSlideshowSlides( $category )
	{
		...
		if ( $category[0] == 'matches' ) {
			...
			$latest_season = end($competition->seasons);
	...
	function loadStyles()
	{
		...
		wp_enqueue_style('leaguemanager-print', LEAGUEMANAGER_URL . "/css/print.css", false, '1.0', 'print');
		wp_enqueue_style('leaguemanager', LEAGUEMANAGER_URL . "/css/style.css", false, '1.0', 'screen');
	...
	function activate()
	{
		...
		$options['logos']['tiny_size'] = array('width' => 40, 'height' => 40);
		$options['logos']['thumb_size'] = array('width' => 100, 'height' => 100);
		$options['logos']['large_size'] = array('width' => 1024, 'height' => 1024);
		$options['logos']['crop_image'] = array('tiny' => 1, 'thumb' => 1, 'medium' => 0, 'large' => 0);
