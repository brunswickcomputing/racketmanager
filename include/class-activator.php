...
class Activator {
    ...
    public static function install(): void {
        ...
        $create_charges_sql = "CREATE TABLE $wpdb->racketmanager_charges ( `id` int NOT NULL AUTO_INCREMENT,`competition_id` int DEFAULT NULL, `season` varchar(255) NOT NULL DEFAULT '', `date` date DEFAULT NULL,`status` varchar(50) NOT NULL DEFAULT '', `fee_competition` decimal(10,2) DEFAULT NULL, `fee_event` decimal(10,2) DEFAULT NULL,  PRIMARY KEY (`id`) ) ENGINE=InnoDB $charset_collate;";
        maybe_create_table( $wpdb->racketmanager_charges, $create_charges_sql );
        $create_clubs_sql = "CREATE TABLE $wpdb->racketmanager_clubs ( `id` int NOT NULL AUTO_INCREMENT, `name` varchar(100) NOT NULL DEFAULT '', `website` varchar(100) NOT NULL DEFAULT '', `type` varchar(20) NOT NULL DEFAULT '', `address` varchar(255) NOT NULL DEFAULT '',  `latitude` varchar(20) NOT NULL DEFAULT '', `longitude` varchar(20) NOT NULL DEFAULT '', `contactno` varchar(20) NOT NULL DEFAULT '', `founded` int DEFAULT NULL, `facilities` varchar(255) NOT NULL DEFAULT '', `shortcode` varchar(20) NOT NULL DEFAULT '',  PRIMARY KEY (`id`) ) ENGINE=InnoDB $charset_collate;";
        ...
        $create_club_roles_sql = "CCREATE TABLE {$wpdb->racketmanager_club_roles} ( `id` int( 11 ) NOT NULL AUTO_INCREMENT, `club_id` int( 11 ) NOT NULL, `role_id` int( 11 ) NOT NULL, `user_id` int( 11 ) NOT NULL, PRIMARY KEY ( `id` ) ) ENGINE=InnoDB $charset_collate;";
        maybe_create_table( $wpdb->racketmanager_club_roles, $create_club_roles_sql );
