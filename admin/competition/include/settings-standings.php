...
<div class="form-group">
  ...
  <div class="form-input">
    <input type="number" step="1" min="0" class="small-text" name="settings[num_ascend]" id="teams_ascend" value="<?php echo $competition->num_ascend ?>" size="2" />
  </div>
</div>
<div class="form-group">
  <div class="form-label">
  ...
  <div class="form-input">
    <input type="number" step="1" min="0" class="small-text" name="settings[num_descend]" id="teams_descend" value="<?php echo $competition->num_descend ?>" size="2" />
  </div>
</div>
<div class="form-group">
  <div class="form-label">
  ...
  <div class="form-input">
    <input type="number" step="1" min="0" class="small-text" name="settings[num_relegation]" id="teams_relegation" value="<?php echo $competition->num_relegation ?>" size="2" />
  </div>
</div>
