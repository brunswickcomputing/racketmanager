<div class="championship-block">
  <form action="" method="post" style="display: inline;">
    ...
    <p><?php _e( 'After adding the teams and arranging the rankings then ', 'racketmanager' ) ?></p><input type="submit" class="button-primary" value="<?php _e( 'Proceed to Final Rounds', 'racketmanager' ) ?>" name="startFinals" />
