...
<div class="container">
    ...
    <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="competitions-tab" data-bs-toggle="tab" data-bs-target="#competitions-league" type="button" role="tab" aria-controls="competitions-league" aria-selected="false"><?php esc_html_e( 'Leagues', 'racketmanager' ); ?></button>
        </li>
        <li class="nav-item" role="presentation">
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                <select class="form-select" name="<?php echo esc_html( $competition_type ); ?>[matchCapability]" id="<?php echo esc_html( $competition_type ); ?>-matchCapability">
                                    <option value="none" <?php selected( 'none', $options[ $competition_type ]['matchCapability'] ?? null ); ?>><?php esc_html_e( 'None', 'racketmanager' ); ?></option>
                                    <option value="captain" <?php selected( 'captain', $options[ $competition_type ]['matchCapability'] ?? null ); ?>><?php esc_html_e( 'Captain', 'racketmanager' ); ?></option>
                                    <option value="player"<?php selected( 'player', $options[ $competition_type ]['matchCapability'] ?? null ); ?>><?php esc_html_e( 'Player', 'racketmanager' ); ?></option>
                                </select>
                        ...
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                <select class="form-select" id="<?php echo esc_html( $competition_type ); ?>-resultEntry" name="<?php echo esc_html( $competition_type ); ?>[resultEntry]">
                                    <option value="none" <?php selected( 'none', $options[ $competition_type ]['resultEntry'] ?? null ); ?>><?php esc_html_e( 'None', 'racketmanager' ); ?></option>
                                    <option value="home" <?php selected( 'home', $options[ $competition_type ]['resultEntry'] ?? null ); ?>><?php esc_html_e( 'Home', 'racketmanager' ); ?></option>
                                    <option value="either" <?php selected( 'either', $options[ $competition_type ]['resultEntry'] ?? null ); ?>><?php esc_html_e( 'Either', 'racketmanager' ); ?></option>
                                </select>
                        ...
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                <select class="form-select" id="<?php echo esc_html( $competition_type ); ?>-resultConfirmation" name="<?php echo esc_html( $competition_type ); ?>[resultConfirmation]">
                                    <option value="none" <?php selected( 'none', $options[ $competition_type ]['resultConfirmation'] ?? null ); ?>><?php esc_html_e( 'None', 'racketmanager' ); ?></option>
                                    <option value="auto" <?php selected( 'auto', $options[ $competition_type ]['resultConfirmation'] ?? null ); ?>><?php esc_html_e( 'Automatic', 'racketmanager' ); ?></option>
                                </select>
                        ...
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                <select class="form-select" id="<?php echo esc_html( $competition_type ); ?>-resultNotification" name="<?php echo esc_html( $competition_type ); ?>[resultNotification]">
                                    <option value="none" <?php selected( 'none', $options[ $competition_type ]['resultNotification'] ?? null ); ?>><?php esc_html_e( 'None', 'racketmanager' ); ?></option>
                                    <option value="captain" <?php selected( 'captain', $options[ $competition_type ]['resultNotification'] ?? null ); ?>><?php esc_html_e( 'Captain', 'racketmanager' ); ?></option>
                                    <option value="secretary" <?php selected( 'secretary', $options[ $competition_type ]['resultNotification'] ?? null ); ?>><?php esc_html_e( 'Match Secretary', 'racketmanager' ); ?></option>
                                </select>
                    ...
                    <fieldset class="row gx-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                ...
                                <label for='<?php echo esc_html( $competition_type ); ?>-resultPending'><?php esc_html_e( 'Chasing pending result (hours)', 'racketmanager' ); ?></label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                ...
                                <label for="<?php echo esc_html( $competition_type ); ?>-resultTimeout"><?php esc_html_e( 'Result timeout (hours)', 'racketmanager' ); ?></label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                ...
                                <label for='<?php echo esc_html( $competition_type ); ?>-resultPenalty'><?php esc_html_e( 'Result penalty', 'racketmanager' ); ?></label>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="row gx-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                ...
                                <label for='<?php echo esc_html( $competition_type ); ?>-confirmationPending'><?php esc_html_e( 'Chase result confirmation (hours)', 'racketmanager' ); ?></label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                ...
                                <label for='<?php echo esc_html( $competition_type ); ?>-confirmationTimeout'><?php esc_html_e( 'Result confirmation timeout (hours)', 'racketmanager' ); ?></label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
                            <div class="form-floating">
                                ...
                                <label for='<?php echo esc_html( $competition_type ); ?>-confirmationPenalty'><?php esc_html_e( 'Result confirmation penalty', 'racketmanager' ); ?></label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3 mb-md-0">
