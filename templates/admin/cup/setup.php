    ...
    <form method="post" class="form-control mb-3">
        ...
        foreach ( $object->finals as $final ) {
            ...
            <div class="row mb-3">
                ...
                <div class="col-4">
                    <label class="visually-hidden" for="rounds-<?php echo esc_attr( $round ); ?>-match_date"><?php esc_html_e( 'Round date', 'racketmanager' ); ?></label><input type="date" class="form-control" value="<?php echo esc_html( $round_date ); ?>" name="rounds[<?php echo esc_attr( $round ); ?>][match_date]" id="rounds-<?php echo esc_attr( $round ); ?>-match_date" />
                </div>
            </div>
            <?php
            --$match_date_index;
