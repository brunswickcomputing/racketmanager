			...
			?>
				...
				<form name="memberaccountform" id="memberaccountform" action="<?php echo esc_url( site_url( 'member-account' ) ); ?>" method="post" autocomplete="off">
					...
					<div class="row">
						<ul class="">
							<li class="block block--border">
								<h2 class="block--title"><?php esc_html_e( 'Personal', 'racketmanager' ); ?></h2>
								<div class="form-floating mb-3 <?php echo ( isset( $user_data['first_name_error'] ) ) ? ' is-invalid' : ''; ?>">
					...
					<div class="row">
						<ul class="">
							<li class="block block--border">
								<h2 class="block--title"><?php esc_html_e( 'Contact', 'racketmanager' ); ?></h2>
								<div class="form-floating mb-3">
					...
					<div class="row">
						<ul class="">
							<li class="block block--border">
								<h2 class="block--title"><?php esc_html_e( 'Account', 'racketmanager' ); ?></h2>
