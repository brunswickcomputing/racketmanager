                    ...
                    for ( $i = 0; $i < $max_matches; $i++ ) {
                        ...
                        <tr class="">
                            ...
                            <td>
                                ...
                                if ( $single_cup_game ) {
                                    ?>
                                    <label for="home_team_title_<?php echo esc_html( $i ); ?>" class="visually-hidden"><?php esc_html_e( 'Home team', 'racketmanager' ); ?></label><input type="text" disabled name="home_team_title[<?php echo esc_html( $i ); ?>]" id="home_team_title_<?php echo esc_html( $i ); ?>" value="<?php echo esc_html( $home_title ); ?>" />
                            ...
                            <td>
                                ...
                                if ( $single_cup_game ) {
                                    ?>
                                    <label for="away_team_title_<?php echo esc_html( $i ); ?>" class="visually-hidden"><?php esc_html_e( 'Away team', 'racketmanager' ); ?></label><input type="text" disabled name="away_team_title[<?php echo esc_html( $i ); ?>]" id="away_team_title_<?php echo esc_html( $i ); ?>" value="<?php echo esc_html( $away_title ); ?>" />
                                    ...
                                    ?>
                                    <label for="away_team_<?php echo esc_html( $i ); ?>" class="visually-hidden"><?php esc_html_e( 'Away team', 'racketmanager' ); ?></label><select size="1" name="away_team[<?php echo esc_html( $i ); ?>]" id="away_team_<?php echo esc_html( $i ); ?>"<?php echo empty( $final_key ) ? null : ' onChange="Racketmanager.insertHomeStadium(document.getElementById(\'home_team_' . esc_html( $i ) . '\').value, ' . esc_html( $i ) . ');"'; ?>>
                                        <?php
                                        foreach ( $teams as $team ) {
                                            ?>
