    ...
    <div id="competitions-<?php echo $competitiontype ?>" class="league-block-container">
        <form id="competitions-filter" method="post" action="">
            ...
            <table class="widefat" summary="" title="LeagueManager Competitions">
                ...
                <tbody id="the-list">
                <?php $competitions = $leaguemanager->getCompetitions( array('type' => $competitiontype) );
                    $class = '';
...
<form action="" method="post">
    ...
    <div class="form-group">
        <label for="competition_name"><?php _e( 'Competition', 'leaguemanager' ) ?></label>
		<div class="input">
            <input required="required" placeholder="<?php _e( 'Enter name for new competition', 'leaguemanager') ?>" type="text" name="competition_name" id="competition_name" value="" size="30" />
        </div>
    </div>
    <div class="form-group">
        <label for='num_sets'><?php _e('Number of Sets', 'leaguemanager') ?></label>
        <div class="input">
            <input required="required" placeholder="<?php _e( 'How many sets', 'leaguemanager') ?>" type='number' name='num_sets' id='num_sets' value='' size='3' />
        </div>
    </div>
    <div class="form-group">
        <label for='num_rubbers'><?php _e('Number of Rubbers', 'leaguemanager') ?></label>
        <div class="input">
            <input required="required" placeholder="<?php _e( 'How many rubbers', 'leaguemanager') ?>" type='number' name='num_rubbers' id='num_rubbers' value='' size='3' />
        </div>
    </div>
    <div class="form-group">
        <label for='competition_type'><?php _e('Competition Type', 'leaguemanager') ?></label>
        <div class="input">
    ...
    <div class="form-group">
        <label for="mode"><?php _e( 'Mode', 'leaguemanager' ) ?></label>
        <div class="input">
    ...
    <div class="form-group">
        <label for="entryType"><?php _e( 'Entry Type', 'leaguemanager' ) ?></label>
        <div class="input">
