...
<div class="container">
    ...
    <div class="row mb-3">
        <h1><?php echo esc_html( __( 'Invoice', 'racketmanager' ) . ' invoice.php' . $invoice->invoice_number . ' (' . $invoice->status . ')' ); ?></h1>
        <h2><?php echo esc_html( ucfirst( $invoice->charge->competition->name ) . ' invoice.php' . $invoice->charge->season . ' - ' . $inv_name ); ?><h2>
    </div>
