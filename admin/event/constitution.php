	...
	<form id="teams-filter" method="post" action="">
		...
		<table class="table table-striped" title="RacketManager" aria-label="constitution table">
			<thead class="table-dark">
				<tr>
					<th scope="col" class="check-column"><label for="check-all-teams"></label><input type="checkbox" id="check-all-teams" onclick="Racketmanager.checkAll(document.getElementById('leagues-filter'));" /></th>
					...
					foreach ( $teams as $team ) {
						...
						<tr class="<?php echo esc_html( $class ); ?>">
							<th scope="row" class="check-column">
                                <label for="table-<?php echo esc_html( $team->table_id ); ?>"></label><input type="checkbox" value="<?php echo esc_html( $team->table_id ); ?>" name="table[<?php echo esc_html( $team->table_id ); ?>]" id="table-<?php echo esc_html( $team->table_id ); ?>" />
							...
							<td class="column-num">
                                <label for="rank[<?php echo esc_html( $team->table_id ); ?>]"></label><input type="text" size="2" class="rank-input" name="rank[<?php echo esc_html( $team->table_id ); ?>]" id="rank[<?php echo esc_html( $team->table_id ); ?>]" value=<?php echo esc_html( $team->rank ); ?> />
							</td>
