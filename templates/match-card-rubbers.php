							...
							<tr class="rtr">
								...
								<?php for ( $i = 1; $i <= $match->league->num_sets; $i++ ) { ?>
									<td rowspan="2" class="rtd">
                                        <label for="set_<?php echo esc_html( $r ); ?>_<?php echo esc_html( $i ); ?>_player1"></label><input class="points" type="text" size="2" id="set_<?php echo esc_html( $r ); ?>_<?php echo esc_html( $i ); ?>_player1" name="custom[<?php echo esc_html( $r ); ?>][sets][<?php echo esc_html( $i ); ?>][player1]" />
										:
                                        <label for="set_<?php echo esc_html( $r ); ?>_<?php echo esc_html( $i ); ?>_player2"></label><input class="points" type="text" size="2" id="set_<?php echo esc_html( $r ); ?>_<?php echo esc_html( $i ); ?>_player2" name="custom[<?php echo esc_html( $r ); ?>][sets][<?php echo esc_html( $i ); ?>][player2]" />
									</td>
								<?php } ?>

								<td class="rtd">
                                    <label for="away_player_1_<?php echo esc_html( $r ); ?>"></label><input class="player" name="away_player_1[<?php echo esc_html( $r ); ?>]" id="away_player_1_<?php echo esc_html( $r ); ?>" />
								</td>
							</tr>
							<tr class="rtr">
								<td class="rtd">
                                    <label for="home_player_2_<?php echo esc_html( $r ); ?>"></label><input class="player" name="home_player_2[<?php echo esc_html( $r ); ?>]" id="home_player_2_<?php echo esc_html( $r ); ?>" />
								</td>
								<td class="rtd">
                                    <label for="away_player_2_<?php echo esc_html( $r ); ?>"></label><input class="player" name="away_player_2[<?php echo esc_html( $r ); ?>]" id="away_player_2_<?php echo esc_html( $r ); ?>">
								</td>
							</tr>
							<tr>
								<td colspan="<?php echo esc_html( $points_span ); ?>" class="rtd" style="text-align: center;">
                                    <label for="home_points-<?php echo esc_html( $r ); ?>"></label><input class="points" type="text" size="2" id="home_points-<?php echo esc_html( $r ); ?>" name="home_points[<?php echo esc_html( $r ); ?>]" />
									:
                                    <label for="away_points-<?php echo esc_html( $r ); ?>"></label><input class="points" type="text" size="2" id="away_points-<?php echo esc_html( $r ); ?>" name="away_points[<?php echo esc_html( $r ); ?>]" />
								</td>
							</tr>
							<?php
							++$r;
